...
1. **Архитектура проекта**
   ...
   - Создать документацию по архитектурным решениям
...
4. **Базовая конфигурация Firebase**
...
3. **Модуль операций (Operations)**
   - Форма добавления операции с полной валидацией
...
- Валидация данных в Cloud Functions перед записью
